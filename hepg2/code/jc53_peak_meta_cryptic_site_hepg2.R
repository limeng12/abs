...
#system("scp /Users/mengli/Documents/projects/abs/hepg2/data/star_target_only_jc_bedgraph/* limeng@10.10.114.148:/home/limeng/Documents/projects/abs/data/star_target_only_jc_bedgraph_hepg2/");
...
meta_5_3<-function(rbp){
  ...
  y<-read_bedgraph(paste0("/Users/mengli/Documents/projects/abs/hepg2/data/star_target_only_jc_bedgraph/",
...
pdf("hepg2/result/jc_meta_cryptic_site_hepg2.pdf", width=15, height = 8);
library(stringr);
files_all<-list.files("/Users/mengli/Documents/projects/abs/hepg2/data/star_target_only_jc_bedgraph");
