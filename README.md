...
Read count support cryptic splice sites account \frac{5}{10000} in average, this make sensitivity is key thing to consider when analyzing cryptic splice sites. So after all, I choose `STAR` to do alignment since it can detect highest number of cryptic splice sites.
